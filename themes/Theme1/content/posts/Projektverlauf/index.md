...
Der Aufbau war dabei das größte Problem. Wo lege ich die Münze drauf, wie fliegt sie in die Sortierschiene, wie sind die Maße. 
...
Sich einen groben Überblick verschaffen, Ideen sammeln, Skizzen erstellen und sich in erster Linie in das Projekt eindenken. Insgesamt bin ich selbständiger geworden und habe Lust bekommen selber Projekte anzupacken. Aber erstmal nur Softwareseitige Projekte.
...
Nachdem die Münze auf die Platte mit den Drähten gelegt wurde, hat sich dadurch ein Stromkreis geschlossen. Dies wurde am angeschlossenen Pin (Plus-Pol) erkannt.     Nun fängt sich der Motor an zu drehen. 
...
Der letzte Sensor, der positiv ausgelöst hat ist derjenige durch den die Münze gefallen ist. 

Durch diese Information können wir den Wert der eingeschmissenen Münze ermitteln und auf unseren Kontostand addieren. 

Dieser Kontostand wird dann auch dem OLED-Display ausgegeben.
